    ...
    <el-dialog
      ...
      <el-form v-loading="submitLoading" ref="userDto" :model="userDto" :rules="userDtoRules" label-width="100px" label-suffix="：" status-icon>
        ...
        <el-form-item label="身份" prop="roleId">
          <el-radio v-model="userDto.roleId" label="0">游客</el-radio>
          <el-radio v-model="userDto.roleId" label="2">普通用户</el-radio>
          <el-radio v-model="userDto.roleId" label="1">管理员</el-radio>
        </el-form-item>
