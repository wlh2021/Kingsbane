<template>
   <div style="margin-top: 100px">
      <h2 style="margin-bottom: 25px">留下评论</h2>
      <el-form
        :inline="true"
        :model="ruleForm"
        :rules="rules"
      ...
      >
        <el-form-item style="width: 30%" prop="username">
          <el-input v-model="ruleForm.username" placeholder="名称*"></el-input>
        </el-form-item>
      ...
      <el-button type="primary" :loading="loading" @click="createcomment()"
        >发表评论</el-button
      >
      </div>
</template>
